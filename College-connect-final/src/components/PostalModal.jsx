...
import {addPost} from "../routes/routes";
					...
					<Content>
						...
						<SharedContent>
							...
							<Editor>
								...
								{assetArea === "image" ? (
									<UploadImage>
										<input type="file" accept="image/gif, image/jpeg, image/jpg, image/png" name="image" id="imageFile" onChange={handleImage} style={{ display: "none" }} />
										<p>
